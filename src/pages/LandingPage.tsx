...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-2 gap-8">
            {[
              ...
              { value: '1,200+', label: 'Prescriptions documented per clinic per month', icon: FileText }
            ].map((metric, index) => (
      ...
      {/* Voice to SOAP Animation Section */}
      <section id="demo-section" className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Watch Voice Transform Into SOAP Notes
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              See how Medora AI converts your consultation into structured documentation in real-time
            </p>
          </div>

          <VoiceToSoapAnimation />
        </div>
      </section>
