#!/usr/bin/env python3
"""
Simple script to process Plumb's Veterinary Drug Handbook PDF without emoji characters
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python process_plumb_simple.py <pdf_path> [openai_api_key]")
        print("Example: python process_plumb_simple.py ./plumb-veterinary-drug-handbook.pdf")
